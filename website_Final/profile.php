...
if (!isset($_SESSION['userSession'])) {
 ...
 $filename = glob("uploads/".$_SESSION['userSession'].".*");
...
<!-- other stuff -->
			<div class="row justify-content-center" style="margin-top: 200px">
				<img class="figure-img img-fluid rounded-circle" src=<?php echo $filename[0]; ?> alt="user image"  style="z-index: 0;border: 10px solid white;">
			</div>
